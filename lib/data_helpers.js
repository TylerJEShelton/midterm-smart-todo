...
// This function is passed a database and a category ID and returns the list of items for a specific category ID sorted by the date the items were added.
const getItemsByCategory = (db, categoryId) => {
